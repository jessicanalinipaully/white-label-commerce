    ...
    <section className="my-12 p-8 sm:p-12 rounded-3xl bg-slate-900 border border-slate-800 text-center space-y-6">
      ...
      {section.buttonText && section.buttonUrl && (
        <Link
          ...
          className="inline-block px-8 py-3.5 rounded-xl bg-primary hover:bg-primary-hover font-bold text-white transition-all shadow-lg shadow-primary/30 text-sm"
        >
          {section.buttonText}
        </Link>
      )}
